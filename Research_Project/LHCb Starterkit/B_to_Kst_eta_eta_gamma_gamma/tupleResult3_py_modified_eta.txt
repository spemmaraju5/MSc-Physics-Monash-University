...
ParticlePropertySvc().Particles = ["eta                    17         221   0.0      0.954     5.063171e-19                      eta         221      0.00000000"]
decay = "[[B0]nos => ^(K*(892)0 ==> K+ pi-) ^(eta => ^gamma ^gamma)]CC"
datafile = "Gauss-11102441-10ev-20220908.xgen"
...
mctuple.addTupleTool(
    'LoKi::Hybrid::MCTupleTool/basicLoKiTT').Variables = mc_basic_loki_vars
...
# Configure DaVinci
DaVinci().TupleFile = "DVntupleHM.root"
